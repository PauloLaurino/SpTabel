...
- **Endpoint**: `http://100.102.13.23:8049/notas/maker/api/notas/selos/recepcao`
...
3. Envia JSON PRONTO para → http://100.102.13.23:8049/notas/...
    ↓
Servidor (notas.war - versão 12/03)
    ↓
...
- Recepção: `/maker/api/notas/selos/recepcao`
- Reenviar: `/maker/api/notas/selos/reenviar-lote`
- Sanitizar/Reenviar: `/maker/api/notas/selos/sanitizar-reenviar`
- Consultar Protocolo: `/maker/api/notas/selos/protocolo`
