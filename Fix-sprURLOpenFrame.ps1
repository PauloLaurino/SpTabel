# Fix-sprURLOpenFrame.ps1
# Versão Pro-Max: Maker 5 + Context Inheritance + Auto-Sizing
# Agora também propaga automaticamente parâmetros de contexto como sys e database.
...
Write-Host "Atualizando sprURLOpenFrame..." -ForegroundColor Cyan
# Salva o código em um arquivo temporário para ser usado em injeções ou atualizações
$sprCode | Out-File -FilePath "sql/sprURLOpenFrame_v5.js" -Encoding utf8
Write-Host "SUCESSO! Versão Maker 5 + Contexto gerada em sql/sprURLOpenFrame_v5.js" -ForegroundColor Green
