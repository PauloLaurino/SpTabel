...
export default function Layout({ children }: LayoutProps) {
  ...
  return (
    <div className="h-screen flex flex-col bg-[#0b141a]">
      {/* Header */}
      <header className="h-14 bg-[#202c33] flex items-center justify-between px-4 border-b border-[#2a3942]">
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2">
            ...
            <div className="hidden md:block">
              ...
              <p className="text-[#8696a0] text-xs">{user?.perfil}</p>
            </div>
          </div>
          ...
          <button
            ...
            title="Sair"
          >
            <LogOut className="w-5 h-5 text-[#8696a0]" />
          </button>
        </div>
      </header>
