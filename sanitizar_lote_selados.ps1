# Script para sanitização em lote de selados.JSON
...
Write-Host "  Sanitização em Lote de selados.JSON" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""

# 1. Consultar selos pendentes
Write-Host "[1/4] Consultando selos pendentes..." -ForegroundColor Yellow
...
$totalSelos = $linesSelos.Count - 1  # Descontar cabeçalho

Write-Host "   Total de selos pendentes: $totalSelos" -ForegroundColor Green
Write-Host ""

# 2. Processar cada selo
Write-Host "[2/4] Processando selos..." -ForegroundColor Yellow
...
"@
        ...
        Write-Host "      OK - Arquivo gerado: selados_$seloDigital.JSON12" -ForegroundColor Green
        $sucessos++
...
Write-Host ""
Write-Host "[3/4] Resumo do processamento:" -ForegroundColor Yellow
...
# 4. Verificar status de recepção
Write-Host "[4/4] Verificando status de recepção..." -ForegroundColor Yellow
